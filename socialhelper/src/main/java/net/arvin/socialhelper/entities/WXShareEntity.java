...
public final class WXShareEntity extends ShareEntity {
    ...
    public static final String KEY_WX_IMG_BYTES = "key_wx_img_bytes";
     ...
     * @param bytes    应用内图片资源
     */
    public static ShareEntity createImageInfo(@ParamsRequired boolean isTimeLine, @ParamsRequired byte[] bytes) {
        ShareEntity entity = new ShareEntity(isTimeLine ? TYPE_PYQ : TYPE_WX);
        addParams(entity.params, KEY_WX_TYPE, TYPE_IMG);
        addParams(entity.params, KEY_WX_IMG_BYTES, bytes);
        return entity;
    }
